...
| 分类       | 可配置内容                                         |
| ---------- | -------------------------------------------------- |
| 基础体验   | 刷新间隔、RPC 连接、默认视图、登录入口             |
| 节点展示   | 延迟图表、延迟与丢包摘要、分组过滤                 |
| 卡片与列表 | 卡片材质、不透明度、进度条布局、状态样式、流量颜色 |
| 页面布局   | 最大宽度、全宽模式、界面密度                       |
| 颜色与字体 | 种子色、预设调色盘、壁纸取色、界面字体与数字字体   |
| 数据格式   | 运行时间精度、B/KB/MB/GB/TB 小数位数               |
| 公告与备案 | 首页公告、ICP 备案、公安备案                       |
